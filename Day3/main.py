...
if dir == "left":
    act = input ('You come to a lake. There is an island in the middle of the lake.'
    ...
    if act == "wait":
        ...
        if color == "red":
            ...
            print("You entered a dragon's room. Game Over!")
        else:
            print("The door doesn't exist. Game Over!")
    else:
        print("You were attacked by an angry shark. Game Over!")
elif dir == "right":
    print("You fell into the bottom of the cliff. Game Over!")
else:
